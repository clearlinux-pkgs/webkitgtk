...
%prep
%setup -q -n webkitgtk-2.36.7
cd %{_builddir}/webkitgtk-2.36.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661459399
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libjavascriptcoregtk-4.1.so.0.1.11
/usr/lib64/glibc-hwcaps/x86-64-v3/libwebkit2gtk-4.1.so.0
/usr/lib64/glibc-hwcaps/x86-64-v3/libwebkit2gtk-4.1.so.0.1.11
/usr/lib64/libjavascriptcoregtk-4.1.so.0
/usr/lib64/libjavascriptcoregtk-4.1.so.0.1.11
/usr/lib64/libwebkit2gtk-4.1.so.0
/usr/lib64/libwebkit2gtk-4.1.so.0.1.11
